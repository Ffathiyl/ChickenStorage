...
export default function MenuIndex() {
    ...
    const listMenus = () => axios.get(REST_API_BASE_URL + '/getMenuActive');
                                ...
                                {menus.map((menu) => (
                                    <div className="col mb-5" key={menu.idMenu}>
                                        <div className="card h-100 position-relative">
                                            {/* Edit button */}
                                            <Link className="btn btn-edit position-absolute top-0 end-0 mt-2 me-2" to={`/EditMenu/${menu.idMenu}`}>
                                                <i className="fa fa-edit"></i>
                                            </Link>
                                            {/* Delete button */}
                                            <button className="btn btn-delete position-absolute top-0 start-0 mt-2 ms-2" onClick={() => handleDelete(menu.idMenu)}>
